...
export const ClipboardIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M15.666 3.888A2.25 2.25 0 0013.5 2.25h-3c-1.03 0-1.9.693-2.166 1.638m7.332 0c.055.194.084.4.084.612v3.75m-8.166-4.362a2.25 2.25 0 00-2.166 1.638m7.332 0c.055.194.084.4.084.612v3.75m-8.166-4.362L3 12m18 0l-3.166-3.166m-11.666 0L3 12m18 0l-3.166-3.166M3 12l3.166 3.166m11.666 0L21 12m-18 0h18" />
    </svg>
);

export const ClipboardCheckIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M15.666 3.888A2.25 2.25 0 0013.5 2.25h-3c-1.03 0-1.9.693-2.166 1.638m7.332 0c.055.194.084.4.084.612v3.75m-8.166-4.362a2.25 2.25 0 00-2.166 1.638m7.332 0c.055.194.084.4.084.612v3.75m0 0a2.25 2.25 0 01-2.25 2.25h-5.25a2.25 2.25 0 01-2.25-2.25m10.5 0l-3.166-3.166m-7.334 3.166l-3.166-3.166m13.5 0l-3.166-3.166M3.75 12.75h16.5m-16.5 3.75h16.5M12 18.75h.008v.008H12v-.008z" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 10.5l-4.5 4.5-2.25-2.25" />
    </svg>
);
